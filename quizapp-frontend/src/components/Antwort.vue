<template>
    <div class="antwortbox">
        <span class="antwortUnterbox">
            ...
            <div class="antwortUL" v-if="antwortKennung == antwort.id" style="cursor: pointer" @click="antwortGewaehlt(2)" 
        ...
        <span class="antwortUnterbox">
            <div class="antwortUL" v-if="antwortKennung == antwort.id" style="cursor: pointer" @click="antwortGewaehlt(3)" 
            ...
            <div class="antwortUL" v-if="antwortKennung == antwort.id" style="cursor: pointer" @click="antwortGewaehlt(4)" 
